...
echo_and_run cd "/home/zack/rob421/Marco_Polo_Sphero/ws/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/zack/rob421/Marco_Polo_Sphero/ws/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/zack/rob421/Marco_Polo_Sphero/ws/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
