...
echo_and_run cd "/home/zack/rob421/Marco_Polo_Sphero/ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/zack/rob421/Marco_Polo_Sphero/ws/src/rosserial/rosserial_vex_cortex/setup.py" \
    build --build-base "/home/zack/rob421/Marco_Polo_Sphero/ws/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
